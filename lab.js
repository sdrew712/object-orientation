...
let cat1 = new Cat("Minino", 4, "black");
...
let wizard = new Wizard("Harry Potter", 18, "expelliarmus")
...
let phone1 = new Phone("Apple", "iPhone X", 64, "Space Gray", 700);
let phone2 = new Phone("Google", "Pixel 5", 128, "Black", 800);
let phone3 = new Phone("Samsung", "Galaxy S6", 32, "White", 500);
...
let car = new Vehicle(2, "purple", 50000);
...
let myFirstMotorcycle = new Motorcycle(2, "blue", 30000, "Honda", true)
...
let myFirstBoat = new Boat(8, "white", 10000, "Hannah", "Bayliner", false);
